...
def load_source_zone_data(conn: pyodbc.Connection) -> list[dict] | None:
    ...
    try:
        ...
        for zone_row in zone_rows:
            ...
            zone_totals_row = fetch_zone_totals_data(conn=conn, zone_id=zone_data_row["zone_id"])
            ...
            zone_discrepancy_totals_row = fetch_zone_discrepancy_totals_data(conn=conn, zone_id=zone_data_row["zone_id"])
