...
class TestReportGenerator:
    ...
    def test_emp_data_type_validation(self, invalid_input, sample_team_data):
    ...
    @pytest.mark.parametrize("invalid_input", [None, "string", 123, {}])
    def test_team_data_type_validation(self, invalid_input, sample_emp_data):
    ...
    def test_employee_template_file_missing(self, sample_emp_data, sample_team_data):
    ...
    def test_team_template_file_missing(self, sample_emp_data, sample_team_data):
    ...
    def test_pdf_generation_error(self, sample_emp_data, sample_team_data):
    ...
    def test_successful_pdf_generation(self, sample_emp_data, sample_team_data):
    ...
    def test_tempfile_creation_failure(self, sample_emp_data, sample_team_data):
    ...
    def test_template_rendering_with_data(self, sample_emp_data, sample_team_data):
